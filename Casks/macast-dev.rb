cask "macast-dev" do
  ...
  caveats do
    ...
    <<~EOS
       Macast.app is not signed by a developer license, so it needs root permission to finish the installation.
       We will run the following command to remove the quarantine tag after downloading:
